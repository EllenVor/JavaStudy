...
public class ShoppingMain7 {
    ...
    public static void main(String[] args) {
        ...
        if (item_num>0) {
            ...
            printCostStatistics(TotalCostItem);
    ...
    private static void printCostStatistics(int [] totalcost) {
        ...
        {
            if (totalcost[maxPoint]<totalcost[i]) {maxPoint=i;}
        } */
        System.out.println("****** Cost statistics ******");
        System.out.println("Most expensive item is costs : " + totalcost[totalcost.length-1]);
        System.out.println("Cheapest item costs : " + totalcost[0]);
    }
